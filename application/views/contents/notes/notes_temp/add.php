            ...
            <div class="row">
              <div class="col-md-12">  
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control input-sm" name="data1" id="data1" value="" >
                  </div>
                </div>
                <br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class='input-group'>
                      <input type="text" class="form-control" name="data2" id="data2" value="" required autocomplete="off">
...
<!-- start input panel col 6 kanan kiri -->
    <form id="form-add-2-<?= $this->router->fetch_class(); ?>">
      <input type="hidden" class="form-control input-sm" name="id_reg" id="id_reg" value="<?= $id_reg ?>" >
      <div class="row">
        <div class="col-md-6">
          <div class="panel panel-primary">
...
<!-- start input panel col 12 dalamnya 2 biji col 6  -->
    <form id="form-add-3-<?= $this->router->fetch_class(); ?>">
      <input type="hidden" class="form-control input-sm" name="id_reg" id="id_reg" value="<?= $id_reg ?>" >
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-primary">
...
<script type="text/javascript">
  ...
  $('#form-add-2-<?= $this->router->fetch_class(); ?>').submit(function (e) 
  { 
    e.preventDefault();
    $('.btn-kirim-<?= $this->router->fetch_class(); ?>').attr('disabled', true);
  ...
  $('#form-add-3-<?= $this->router->fetch_class(); ?>').submit(function (e) 
  { 
    e.preventDefault();
    $('.btn-kirim-<?= $this->router->fetch_class(); ?>').attr('disabled', true);
    $.post('<?php echo base_url();?>'+class_name+'/add_process_submenu', $(this).serialize()
    ).done(function(data) {
      var data = JSON.parse(data);
