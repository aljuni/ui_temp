    ...
    <div class="col-md-3">  
      <div class="row">
        ...
        <div class="col-md-12 text-right">
          <a href="<?php echo  base_url() .'laporan_pasien_meninggal' . '/print_pdf';?>" class="btn btn-primary" style=" Margin-top: 10px;"><i class="fa fa-print"></i> PDF</a>
          <a href="<?php echo  base_url() .'laporan_pasien_meninggal' . '/export';?>" class="btn btn-success" style=" Margin-top: 10px;"><i class="fa fa-print"></i> Excel</a>
        </div>
