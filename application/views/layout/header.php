<div class="load-nav">
        ...
        <a class="nav menu <?php if($this->uri->segment(1) == 'notes_temp'){echo 'selected';} ?>" href="<?php echo base_url('notes_temp/list');?>">NOTES TEMP</a>
        </div>

        <!-- MENUBAR 2 -->
        <div class="menubar2" id="sub_menu_refrensi">
        <a class="nav menu black-selected" href="<?php echo base_url('notes_temp/list');?>">LIST</a>
